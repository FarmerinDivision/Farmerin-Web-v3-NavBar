...
useEffect(() => {
  if (tamboSel?.id) {
    // Apunta a la ruta que server.js sí maneja
    const cloudFunctionUrl = `https://us-central1-farmerin-navarro.cloudfunctions.net/proxyMonitor/verMonitor?tamboId=${tamboSel.id}`;
      ...
      {linkValido ? (
        <iframe
          ...
          style={{
            ...
            borderRadius: "10px",
            opacity: loading ? 0 : 1, // Se oculta mientras carga
